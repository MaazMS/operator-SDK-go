...
func (r *VisitorsAppReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	result, err = r.ensureDeployment(req, visitor, r.mysqlDeployment(visitor))
	if result != nil {
		return *result, err
	}

	result, err = r.ensureService(req, visitor, r.mysqlService(visitor))
	if result != nil {
		return *result, err
	}

	mysqlRunning := r.isMysqlUp(visitor)
	...
	result, err = r.ensureDeployment(req, visitor, r.backendDeployment(visitor))
	if result != nil {
		return *result, err
	}

	result, err = r.ensureService(req, visitor, r.backendService(visitor))
	if result != nil {
		return *result, err
	}

	err = r.updateBackendStatus(visitor)
	if err != nil {
		return ctrl.Result{}, err
	}

	result, err = r.handleBackendChanges(visitor)
	if result != nil {
		return *result, err
	}
	...
	result, err = r.ensureDeployment(req, visitor, r.frontendDeployment(visitor))
	if result != nil {
		return *result, err
	}

	result, err = r.ensureService(req, visitor, r.frontendService(visitor))
	if result != nil {
		return *result, err
	}

	err = r.updateFrontendStatus(visitor)
	if err != nil {
		return ctrl.Result{}, err
	}

	result, err = r.handleFrontendChanges(visitor)
	if result != nil {
		return *result, err
	}
